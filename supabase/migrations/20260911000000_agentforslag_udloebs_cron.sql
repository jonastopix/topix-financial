...
-- OVERLEVERING DEL 2 «16. september (nat)» §9): cron.job «agentforslag-udloeb»
-- står blandt de 18 aktive jobs. Skrevet 11/9 som «ikke kørt»; filhovedet
-- ført à jour 16/9 («Én plan» fase 0c) — prod er sandheden.
