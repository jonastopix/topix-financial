...
<div style="max-width:520px;margin:0 auto">
  ...
  <div style="background:#ffffff;border-radius:0 0 10px 10px;padding:28px 28px 0">
    ...
    <div style="padding:16px 0">
      <span style="font-size:12px;color:#9ca3af">The Boardroom · theboardroom.dk &nbsp;·&nbsp; <a href="https://app.theboardroom.dk/settings" style="font-size:12px;color:#9ca3af;text-decoration:underline">Administrer notifikationer</a></span>
    </div>
  </div>
</div>
</body>
