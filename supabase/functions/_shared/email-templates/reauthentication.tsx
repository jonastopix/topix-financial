...
const codeStyle = { fontFamily: 'Courier, monospace', fontSize: '28px', fontWeight: 'bold' as const, color: 'hsl(170, 46%, 14%)', letterSpacing: '6px', margin: '0 0 30px', padding: '16px 24px', backgroundColor: '#f4f4f5', borderRadius: '8px', textAlign: 'center' as const }
