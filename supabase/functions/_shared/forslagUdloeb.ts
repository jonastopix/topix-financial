/**
 * supabase/functions/_shared/forslagUdloeb.ts
 *
 * Spejlet fra src/lib/forslagUdloeb.ts — enhver ændring her SKAL også
 * laves der. Pariteten håndhæves af testen i
 * src/lib/__tests__/forslagUdloebParitet.test.ts.
 *
 * Kopien er IKKE ordret: importstien ("./isoUge.ts", som Deno kræver, mod
 * frontendens "./hjemmebane/week") er den ENESTE tilladte forskel mellem
 * de to filer ud over filhovederne. Ugenøglen selv er den samme aritmetik
 * i begge (isoUge.test.ts låser pariteten).
 *
