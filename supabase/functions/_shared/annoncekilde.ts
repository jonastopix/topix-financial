 ...
 * serverens kopi (udkast 20/9-2026, ~/Downloads/udkast-annoncekilde/README.md).
 *
 * Spejlet ORDRET fra src/lib/webinar/annoncekilde.ts — enhver ændring her
 * SKAL også laves der (paritetstest src/lib/__tests__/annoncekilde.paritet.test.ts,
 * webinarDom.paritet-mønstret). Nul imports, ingen Deno-afhængighed.
 *
 * Ingen function læser den endnu (målt 20/9: ewebinar-webhook/-import skriver
 * kolonnen, plukAnnoncespor plukker den, ingen fortolker). Den ligger her, så
 * lag 5/6 og en fremtidig gruppering på kanal bruger SAMME dom som fladen —
 * ikke en tredje stavemåde.
 */
