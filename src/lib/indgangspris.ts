 ...
 *
 * IKKE spejlet til Deno endnu. Når betalingssiden får sin edge function,
 * spejles filen ordret til supabase/functions/_shared/indgangspris.ts med
 * en paritetstest efter fornyelsesprisParitet.test.ts-mønstret — indtil da
 * er denne fil den eneste kilde. Filen har nul imports, så den kan loades
 * af både Vite/Vitest (Node) og Deno uden ændringer.
 *
