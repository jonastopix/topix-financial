 ...
 *
 * IKKE spejlet til Deno endnu. Spejlingen til
 * supabase/functions/_shared/virksomhedsraekke.ts og paritetstesten kommer
 * sammen med den delte oprettelseshjælper — indtil da er denne fil den
 * eneste kilde. Filen har nul imports, så den kan loades af både
 ...
 * funktion får feltlisten testdækning hvor der i dag er ingen. Kilden er
 * import-application/index.ts, trin 3 «Resolve company (reuse or
 * create)» — insert-blokken, parseCvrFoundedDate og navneopløsningen —
 * gengivet felt for felt med hver kommentar der forklarer et valg.
 *
 ...
 * oprettelsen — aldrig gennem denne funktion.
 */
