...
/** Medlemmets fremdriftsrække og dommen over dens tilstand bor i den RENE
    fil progressState.ts (16/9): denne fil importerer Supabase-klienten på
    modulniveau, og de rene motorer (maaskeRelevant, forloeb, lektionBrugbar)
    må ikke trække klienten ind i vitest. Re-eksporteret her, så ingen
    anden kalder ændres. */
...
/* itemProgressState / ItemProgressState: flyttet ordret til progressState.ts
   (16/9) og re-eksporteret øverst i denne fil. */
