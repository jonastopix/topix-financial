/**
 * src/lib/hjemmebane/maal.ts — «Én plan pr. virksomhed», fase 1 (16/9-2026).
 *
 * REN motor for MÅL (milestones) og SKRIDT (company_actions): ingen imports,
 * ingen Supabase, ingen React. SPEJLET i supabase/functions/_shared/maal.ts —
 * enhver ændring her SKAL også laves der; pariteten låses af
 * src/lib/__tests__/maalParitet.test.ts (funktionerne OG kildeteksten efter
 * filhovedet — maanedsnoegle-mønstret). Testet i
 * src/lib/hjemmebane/__tests__/maal.test.ts.
 *
 * Jonas 16/9: én plan — milepælene bliver «Dine mål» (højst tre aktive),
 * opgaverne er skridt under et mål; når alle skridt er gjort, rykker målets
 * fremdrift. Rådgiveren sætter målene; AI'en foreslår højst ét skridt mod et
 * aktivt mål. Reglerne bor HER; skriverne (opgave-luk, foreslaa-opgave, og i
 * fase 5 ugens fokus og agenten) kalder dem og gentager dem ikke.
 */
