/**
 * src/lib/webinar/deling.ts — spejl af supabase/functions/_shared/webinarDeling.ts
 * (udkast webinar-deling 21/9-2026). Kroppen efter filhovedet er ordret ens;
 * pariteten låses af src/lib/__tests__/webinarDashboard.paritet.test.ts.
 * Begrundelserne står dér. Nul imports.
 */
