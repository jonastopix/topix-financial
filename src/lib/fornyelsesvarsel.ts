/**
 * src/lib/fornyelsesvarsel.ts
 *
 * Spejlet i supabase/functions/_shared/fornyelsesvarsel.ts — enhver
 * ændring her SKAL også laves der. Pariteten håndhæves af testen i
 * src/lib/__tests__/fornyelsesvarselParitet.test.ts. Importstien er den
