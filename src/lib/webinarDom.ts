/**
 * webinarDom — dommen bag eWebinar-webhooken, klientens kopi (udkast
 * 19/9-2026). Spejlet ORDRET fra supabase/functions/_shared/webinarDom.ts —
 * enhver ændring her SKAL også laves der (paritetstest
 * src/lib/__tests__/webinarDom.paritet.test.ts). Nul imports.
 *
 * Fladen bruger: webinarLinje + webinarModSvar (ansøgningen: «så 62 % af
 * webinaret 22/9») og webinarTal (tallet Jonas skal se før det får en flade).
 * Filhovedet i _shared-kopien har målingen og begrundelserne.
 */
