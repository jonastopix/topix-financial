...
> ## 14/9 — START HER (skrevet 14/9 formiddag; OPDATERET 14/9 MIDDAG efter #853–#857, og IGEN 14/9 EFTERMIDDAG efter #858–#860 — HEAD `fc3b2565` = #860, merget 11:00:28 UTC; #859 = `a30851cf` 10:44:53; #858 = `048fcbfe` 10:33:32 (middagens bogføring); #857 = `588db663` 10:00:35 UTC; #856 = `0f4d8396` 09:56:59; #855 = `b60df81d` 09:48:17; #854 = `0fd6d216` 09:44:47 (formiddagens bogføring); #853 = `c115e737` 09:23:16; #852 = `66b4a732` 08:01:50; #851 = `72d25525` 07:43:29 UTC. Blokken «13/9 — START HER» nedenfor er historik.)
>
...
| **FORBEREDT 14/9 — IKKE KØRT. BESLUTTET: rate12 på 40.000 (3.500 kr. ekskl. moms), efter at A, B og E var lukket** | **Gennemkørslen** (mangellistens nr. 1): køreplanen i `recon-gennemkoerslen.md` — Monday-oprettelsen, prisen, trinnene efter betalingen med det der kan måles, oprydningen (sletning i platformen, ikke refusion). Den er et bevis, ikke en fejlsøgning, fordi de tre fund er lukket først. | DEL 2 «14. september» §18–§19, §23 |
